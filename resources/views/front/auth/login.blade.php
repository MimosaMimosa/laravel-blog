    ...
    <section class="container-fluid">
        <div class="container">
            <div class="row vh-100 align-items-center justify-content-center">
                <div class="col-md-6">
                    <h4 class="mb-2 fw-bold text-purple">User Login Form</h4>
                    <div class="card border-purple" x-data="login">
                        <div class="card-body">
                            <form action="{{ route('users.authenticated') }}" method="POST" autocomplete="off">
                                @method('POST')
                                @csrf
                                ...
                                <div class="form-group mt-3">
                                    <button class="btn btn-purple text-white w-100">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
